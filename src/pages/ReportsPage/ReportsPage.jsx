...
function ReportsPage() {
  ...
  function getUrgentTasks() {
    ...
    unfinishedTasksList.forEach(
      (e) =>
        (e.remaingDays =
          Math.round((e.dueDate.getTime() - now.getTime()) / (1000 * 3600 * 24)))
    );
  ...
  return (
    <div className="reports-page">
      <div className="top-empoloyees">
        ...
        <h4>(who completed the largest number of tasks in past month)</h4>
      ...
      <div className="top-empoloyees">
        <h1>Urgent tasks</h1>
        <h4>(sorted by remaining time)</h4>
      </div>
      <table className="top-list-wrap">
          <tbody>
            <tr>
      ...
      {getUrgentTasks().map((e) => (
        ...
        <td>
          <p><Moment format="DD/MM/YYYY">{e.dueDate}</Moment></p>
        </td>
      </tr>
    ))}
  </tbody>
